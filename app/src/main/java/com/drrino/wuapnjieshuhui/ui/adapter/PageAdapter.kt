...
class PageAdapter(var data: List<Page> = ArrayList(), val itemClick: (View, Int) -> Unit) : RecyclerView.Adapter<PageAdapter.PageAdapterViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): PageAdapterViewHolder {
